...
public class BookInformationContactProvider extends ContentProvider {

    public static final String AUTHORITY = "com.swyftlabs.swyftbooks";
    public static final String BASE = "com";
    ...
    public static final String MIME_ALL_BOOKS = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.contact.gerardtaylor.com";
    ...
    public BookInformationContactProvider() {
    }
