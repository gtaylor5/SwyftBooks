...
import com.swyftlabs.swyftbooks1.Requests.AmazonRequest;
import com.swyftlabs.swyftbooks1.R;
import com.swyftlabs.swyftbooks1.Classes.ResultItem;
import com.swyftlabs.swyftbooks1.Adapters.SearchResultsAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void initializeRemoteConfig(){
        ...
        defaults.put("IOS_URL", "");
        defaults.put("ANDROID_URL", "");
        ...
        remoteConfig.fetch(3600).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()) {
                    ...
                    iOSURL = remoteConfig.getString("IOS_URL");
                    androidURL = remoteConfig.getString("ANDROID_URL");
                    ...
                    backUpURL = "http://www.swyftbooks.com";
                    amazonRequest = new AmazonRequest(awsSecretKeyID, awsSecretKey);
                }
            }
        });
